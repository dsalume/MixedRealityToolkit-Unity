...
namespace Microsoft.MixedReality.Toolkit.OpenVR.Input
{
    ...
    public class OculusTouchController : GenericOpenVRController
    {
        ...
        public override MixedRealityInteractionMapping[] DefaultLeftHandedInteractions => new[]
        {
            ...
            new MixedRealityInteractionMapping(4, "Axis1D.PrimaryIndexTrigger Press", AxisType.Digital, DeviceInputType.Bumper, ControllerMappingLibrary.AXIS_9),
        ...
        public override MixedRealityInteractionMapping[] DefaultRightHandedInteractions => new[]
        {
            ...
            new MixedRealityInteractionMapping(4, "Axis1D.SecondaryIndexTrigger Press", AxisType.Digital, DeviceInputType.Bumper, ControllerMappingLibrary.AXIS_10),
